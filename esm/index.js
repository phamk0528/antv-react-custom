...
import { Menu, Dropdown, message, Card, Form, Button, Modal, Layout, Select, Cascader, Radio, Checkbox, Tooltip, Popover, PageHeader, Pagination, Spin, ConfigProvider, Input, Empty } from "antd";
import React, { useState, useEffect, useLayoutEffect, useMemo as useMemo$1, useContext, useReducer, useRef, useCallback as useCallback$1 } from "react";
import { S2_PREFIX_CLS, copyData, copyToClipboard, download, getIcon, TOOLTIP_PREFIX_CLS, getTooltipDefaultOptions, BaseTooltip, TOTAL_VALUE, PivotSheet as PivotSheet$1, TableSheet as TableSheet$1, getClassNameWithPrefix, S2Event, customMerge, DEFAULT_OPTIONS, getBaseCellData, getSafetyDataConfig, DataCell, drawObjectText, FONT_FAMILY, isWindows, isUpDataValue, ColCell, safeJsonParse, CustomTreePivotDataSet, EXTRA_FIELD, VALUE_FIELD, getTooltipOptions } from "@antv/s2";
...
const TextIcon = () => /* @__PURE__ */ React.createElement("svg", {
  className: ICON_CLS,
  viewBox: "0 0 1024 1024",
  version: "1.1",
  xmlns: "http://www.w3.org/2000/svg",
...
const DotIcon = () => /* @__PURE__ */ React.createElement("svg", {
  viewBox: "0 0 1024 1024",
  version: "1.1",
  width: "16",
  height: "16"
...
const SwitcherIcon = () => /* @__PURE__ */ React.createElement("svg", {
  className: ICON_CLS,
  width: "16px",
  height: "16px",
  viewBox: "0 0 16 16",
...
const RowIcon = () => /* @__PURE__ */ React.createElement("svg", {
  className: ICON_CLS,
  width: "12px",
  height: "12px",
  viewBox: "0 0 12 12",
...
const ColIcon = () => /* @__PURE__ */ React.createElement("svg", {
  className: ICON_CLS,
  width: "12px",
  height: "12px",
  viewBox: "0 0 12 12",
...
const ValueIcon = () => /* @__PURE__ */ React.createElement("svg", {
  className: ICON_CLS,
  width: "12px",
  height: "12px",
  viewBox: "0 0 12 12",
...
const Export = React.memo((_a) => {
  ...
  const PRE_CLASS2 = `${S2_PREFIX_CLS}-export`;
  const copyData$1 = (isFormat) => {
    const data2 = copyData(sheet, "	", isFormat);
    copyToClipboard(data2, syncCopy).then(() => {
  ...
  const menu = /* @__PURE__ */ React.createElement(Menu, null, /* @__PURE__ */ React.createElement(Menu.Item, {
    key: "copyOriginal",
    onClick: () => copyData$1(false)
  }, copyOriginalText), /* @__PURE__ */ React.createElement(Menu.Item, {
    key: "copyFormat",
    onClick: () => copyData$1(true)
  }, copyFormatText), /* @__PURE__ */ React.createElement(Menu.Item, {
    key: "downloadOriginal",
    onClick: () => downloadData(false)
  }, downloadOriginalText), /* @__PURE__ */ React.createElement(Menu.Item, {
    key: "downloadFormat",
  ...
  }, icon2 || /* @__PURE__ */ React.createElement(DotIcon, null)));
});
...
var htmlIcon = "";
class HtmlIcon extends React.PureComponent {
  render() {
    const { style: style2 = {}, width, height, className, name: name2 } = this.props;
    const svgIcon = () => getIcon(name2);
...
class ReactElement extends React.PureComponent {
  render() {
...
const Icon = (props) => {
  ...
  if (getIcon(icon2)) {
    const name2 = icon2;
    return /* @__PURE__ */ React.createElement(HtmlIcon, __spreadValues(__spreadValues({
      name: name2
    }, TOOLTIP_DEFAULT_ICON_PROPS), attrs));
  }
  return /* @__PURE__ */ React.createElement(ReactElement, __spreadValues(__spreadValues({
    content: icon2
  }, TOOLTIP_DEFAULT_ICON_PROPS), attrs));
};
const TooltipDetail = (props) => {
  const { list = [] } = props;
  return /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-detail-list`
...
const Divider = () => {
  return /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-divider`
  });
};
const TooltipHead = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-head-info-list`
...
const TooltipInfos = (props) => {
  const { infos = "" } = props;
  return /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-infos`
  }, infos);
};
const Interpretation = (props) => {
  const { name: name2, icon: icon2, text, render } = props;
  const renderName = () => {
    return name2 && /* @__PURE__ */ React.createElement("span", {
      className: `${TOOLTIP_PREFIX_CLS}-interpretation-name`
    }, name2);
  };
  const renderText = () => {
    return text && /* @__PURE__ */ React.createElement("div", null, text);
  };
  const renderElement = () => {
    return /* @__PURE__ */ React.createElement(ReactElement, {
      content: render
    });
  };
  return /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-interpretation`
  }, /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-interpretation-head`
...
const TooltipOperator = (props) => {
  ...
  const renderMenus = () => {
    ...
    return map(menus, (menu) => {
      ...
      const menuRender = !isEmpty(children) ? /* @__PURE__ */ React.createElement(Menu, {
        className: `${TOOLTIP_PREFIX_CLS}-operator-menus`,
        onClick: onMenuClick,
        key
      }, map(children, (subMenu) => renderMenu(subMenu))) : /* @__PURE__ */ React.createElement(React.Fragment, null);
  ...
  return !isEmpty(menus) && /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-operator`
  }, renderMenus());
};
const SimpleTips = (props) => {
  const { tips = "", name: name2 = "" } = props;
  return /* @__PURE__ */ React.createElement(React.Fragment, null, name2 && /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-name`
  }, name2), tips && /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-tips`
  }, tips));
};
const ZH_CN = {
  \u5C0F\u8BA1: "Total",
...
const TooltipSummary = React.memo((props) => {
  ...
  const renderSelected = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", {
      ...
      className: `${TOOLTIP_PREFIX_CLS}-selected`
  ...
  const renderSummary = () => {
    return summaries == null ? void 0 : summaries.map((item) => {
      ...
      return /* @__PURE__ */ React.createElement("div", {
        ...
        className: `${TOOLTIP_PREFIX_CLS}-summary-key`
      }, name2, "\uFF08", i18n("\u603B\u548C"), ")"), /* @__PURE__ */ React.createElement("span", {
        className: cx(`${TOOLTIP_PREFIX_CLS}-summary-val`, `${TOOLTIP_PREFIX_CLS}-bold`)
      }, value2));
    });
  };
  return /* @__PURE__ */ React.createElement("div", {
    className: `${TOOLTIP_PREFIX_CLS}-summary`
...
const TooltipComponent = (props) => {
  ...
  const renderOperation = (operator, onlyMenu) => {
    return operator && /* @__PURE__ */ React.createElement(TooltipOperator, {
  ...
  const renderNameTips = (nameTip) => {
    ...
    return /* @__PURE__ */ React.createElement(SimpleTips, {
      name: name2,
      tips
    });
  };
  const renderSummary = (summaries) => {
    return !isEmpty(summaries) && /* @__PURE__ */ React.createElement(TooltipSummary, {
      summaries
    });
  };
  const renderHeadInfo = (headInfo) => {
    const { cols, rows } = headInfo || {};
    return (!isEmpty(cols) || !isEmpty(rows)) && /* @__PURE__ */ React.createElement(React.Fragment, null, renderDivider(), /* @__PURE__ */ React.createElement(TooltipHead, {
      cols,
      rows
    }));
  };
  const renderDetail = (details) => {
    return !isEmpty(details) && /* @__PURE__ */ React.createElement(TooltipDetail, {
      list: details
    });
  };
  const renderInfos = (infos) => {
    return infos && /* @__PURE__ */ React.createElement(TooltipInfos, {
      infos
    });
  };
  const renderInterpretation = (interpretation) => {
    return interpretation && /* @__PURE__ */ React.createElement(Interpretation, __spreadValues({}, interpretation));
  };
  const renderContent = () => {
    ...
    const DefaultContent = /* @__PURE__ */ React.createElement(React.Fragment, null, renderNameTips(nameTip), renderSummary(summaries), renderInterpretation(interpretation), renderHeadInfo(headInfo), renderDetail(details), renderInfos(infos));
    return /* @__PURE__ */ React.createElement(React.Fragment, null, renderOperation(operator), content != null ? content : DefaultContent);
  };
...
class CustomTooltip extends BaseTooltip {
  ...
  renderContent() {
    ...
    ReactDOM.render(/* @__PURE__ */ React.createElement(TooltipComponent, __spreadProps(__spreadValues({}, tooltipProps), {
      content
    })), this.container);
  }
  destroy() {
...
const CustomSort = (props) => {
  ...
  const renderItem = (value2) => {
    ...
    }, /* @__PURE__ */ React.createElement(HtmlIcon, __spreadValues({
      name: "groupAsc"
    }, TOOLTIP_DEFAULT_ICON_PROPS))), /* @__PURE__ */ React.createElement("span", {
      className: `${ADVANCED_PRE_CLS}-split-icon`,
      onClick: () => {
        downHandler(value2);
      }
  ...
  }, splitOrders.map((value2) => /* @__PURE__ */ React.createElement("li", {
    key: value2,
...
const AdvancedSort = ({
  ...
  const renderSider = () => {
    ...
    }, i18n("\u53EF\u9009\u5B57\u6BB5")), /* @__PURE__ */ React.createElement("div", null, map(dimensionList, (item) => {
      return /* @__PURE__ */ React.createElement("div", {
  ...
  const renderContent = () => {
    return /* @__PURE__ */ React.createElement(Content, {
      ...
      className: `${ADVANCED_PRE_CLS}-title`
    }, ruleText || i18n("\u6309\u4EE5\u4E0B\u89C4\u5219\u8FDB\u884C\u6392\u5E8F\uFF08\u4F18\u5148\u7EA7\u7531\u4F4E\u5230\u9AD8\uFF09")), /* @__PURE__ */ React.createElement(Form, {
      form,
      name: "form",
      ...
      return /* @__PURE__ */ React.createElement(Form.Item, {
      ...
      }, i18n("\u6309")), /* @__PURE__ */ React.createElement(Form.Item, {
        name: [field, "rule"],
        ...
        }, i18n("\u8BBE\u7F6E\u987A\u5E8F")), /* @__PURE__ */ React.createElement(Form.Item, {
          noStyle: true,
          name: [field, "sortBy"],
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    onClick: sortClick,
    icon: icon2 || /* @__PURE__ */ React.createElement(SortIcon, null),
    size: "small",
    className: `${ADVANCED_PRE_CLS}-btn`
  }, text || i18n("\u9AD8\u7EA7\u6392\u5E8F")), /* @__PURE__ */ React.createElement(Modal, {
  ...
  }, /* @__PURE__ */ React.createElement(Layout, null, renderSider(), renderContent())), /* @__PURE__ */ React.createElement(Modal, {
    title: i18n("\u624B\u52A8\u6392\u5E8F"),
  ...
  }, /* @__PURE__ */ React.createElement(CustomSort, {
    splitOrders: sortBy,
...
const getSwitcherFieldCfg = (sheet, fieldKey) => {
  const selectable = sheet instanceof PivotSheet$1 && fieldKey === FieldType.Values || sheet instanceof TableSheet$1 && fieldKey === FieldType.Cols;
  const expandable = sheet instanceof PivotSheet$1 && fieldKey === FieldType.Values;
...
const generateSheetConfig = (sheet, result) => {
  const isTableSheet = sheet instanceof TableSheet$1;
...
const getSwitcherClassName = (...classNames) => getClassNameWithPrefix(SWITCHER_PREFIX_CLS, ...classNames);
...
const SingleItem = ({
  ...
  return /* @__PURE__ */ React.createElement("div", __spreadProps(__spreadValues({}, dragHandleProps), {
  ...
  }), ellipsis ? /* @__PURE__ */ React.createElement(Tooltip, {
    ...
    ref
  }, realDisplayName)) : /* @__PURE__ */ React.createElement("div", {
    className: getSwitcherClassName(CLASS_NAME_PREFIX$2, "text"),
    ref
  }, realDisplayName));
};
...
const DimensionItem = ({
  ...
  return /* @__PURE__ */ React.createElement(PublicDraggable, {
    ...
    index: index2,
    isDragDisabled
  }, (provided, snapshot) => /* @__PURE__ */ React.createElement("div", __spreadProps(__spreadValues({}, provided.draggableProps), {
    ref: provided.innerRef,
    className: cx(getSwitcherClassName(selectable ? "checkable-list" : "normal-list"), {
      dragging: snapshot.isDragging,
      "disable-dragging": isDragDisabled
    })
  }), /* @__PURE__ */ React.createElement(SingleItem, {
  ...
  }), expandable && expandChildren && !isEmpty(children) && draggingItemId !== id && /* @__PURE__ */ React.createElement("div", {
    className: cx("child-items", {
      "item-hidden": !expandChildren
    })
  }, children.map((item) => /* @__PURE__ */ React.createElement(SingleItem, {
    key: item.id,
    id: item.id,
    fieldType,
...
const Dimension = (_c) => {
  ...
  return /* @__PURE__ */ React.createElement("div", {
    ...
    className: "title"
  }, /* @__PURE__ */ React.createElement(Icon2, null), " ", /* @__PURE__ */ React.createElement("span", null, text)), expandable && /* @__PURE__ */ React.createElement("div", {
  ...
  }, expandText))), /* @__PURE__ */ React.createElement(ConnectedDroppable, {
    droppableId: fieldType,
    type: droppableType
  }, (provided, snapshot) => /* @__PURE__ */ React.createElement("div", __spreadProps(__spreadValues({
    ref: provided.innerRef
  ...
  }), items.map((item, index2) => /* @__PURE__ */ React.createElement(DimensionItem, __spreadValues({
    key: item.id,
    index: index2,
    fieldType,
    item,
...
const SwitcherContent = (_e) => {
  ...
  return /* @__PURE__ */ React.createElement(DragDropContext, {
  ...
  }, contentTitleText), /* @__PURE__ */ React.createElement("main", {
    className: cx(getSwitcherClassName(CLASS_NAME_PREFIX, "main"), getMainLayoutClassName(nonEmptyCount))
  }, SWITCHER_FIELDS.map((type) => isNil(defaultFields[type]) || /* @__PURE__ */ React.createElement(Dimension, __spreadProps(__spreadValues({}, defaultFields[type]), {
    key: type,
    fieldType: type,
    items: state[type],
    ...
    onClick: onReset
  }, resetText), /* @__PURE__ */ React.createElement("div", {
    className: getSwitcherClassName(CLASS_NAME_PREFIX, "footer", "actions")
  }, /* @__PURE__ */ React.createElement(Button, {
    className: "action-button",
    onClick: onToggleVisible
  }, i18n("\u53D6\u6D88")), /* @__PURE__ */ React.createElement(Button, {
    className: "action-button",
    type: "primary",
    disabled: isNothingChanged,
    onClick: onConfirm
...
const Switcher = (_g) => {
  ...
  return /* @__PURE__ */ React.createElement(Popover, __spreadValues({
    visible,
    content: /* @__PURE__ */ React.createElement(SwitcherContent, __spreadProps(__spreadValues({}, otherProps), {
      onToggleVisible
    })),
  ...
  }, popover), title || /* @__PURE__ */ React.createElement(Button, {
    className: getSwitcherClassName("entry-button"),
    size: "small",
    icon: /* @__PURE__ */ React.createElement(SwitcherIcon, null)
  }, i18n("\u884C\u5217\u5207\u6362")));
};
const SwitcherHeader = (_i) => {
  ...
  return /* @__PURE__ */ React.createElement(Switcher, __spreadValues(__spreadProps(__spreadValues({}, fields), {
    onSubmit
  }), props));
};
var index$2 = "";
const Header = (_k) => {
  ...
  const getExtraComponents = () => {
    return /* @__PURE__ */ React.createElement(React.Fragment, null, extra, switcherCfg.open && /* @__PURE__ */ React.createElement(SwitcherHeader, __spreadValues({
      sheet,
      dataCfg,
      options
    }, switcherCfg)), advancedSortCfg.open && /* @__PURE__ */ React.createElement(AdvancedSort, __spreadValues({
      sheet
    }, advancedSortCfg)), exportCfg.open && /* @__PURE__ */ React.createElement(Export, __spreadValues({
      key: "export",
      sheet
    }, exportCfg)));
  };
  return /* @__PURE__ */ React.createElement(PageHeader, __spreadValues({
    className: cx(PRE_CLASS2, className),
    style: { width },
    ghost: false,
    title,
...
const getSheetComponentOptions = (...options) => customMerge(DEFAULT_OPTIONS, SHEET_COMPONENT_DEFAULT_OPTIONS, ...options);
...
const useCellEvent = (eventName, handler, s2) => {
  React.useEffect(() => {
    const handlerFn = (event) => {
      handler == null ? void 0 : handler(getBaseCellData(event));
    };
    s2 == null ? void 0 : s2.on(eventName, handlerFn);
    return () => {
      s2 == null ? void 0 : s2.off(eventName, handlerFn);
    };
  }, [s2, handler, eventName]);
};
const useS2Event = (eventName, handler, s2) => {
  React.useEffect(() => {
...
function useEvents(props, s2) {
  ...
  useS2Event(S2Event.ROW_CELL_COLLAPSE_TREE_ROWS, props.onRowCellCollapseTreeRows, s2);
  ...
  useS2Event(S2Event.DATA_CELL_TREND_ICON_CLICK, props.onDataCellTrendIconClick, s2);
  useS2Event(S2Event.DATE_CELL_BRUSH_SELECTION, props.onDataCellBrushSelection, s2);
  ...
  useCellEvent(S2Event.CORNER_CELL_DOUBLE_CLICK, props.onCornerCellDoubleClick, s2);
  ...
  useCellEvent(S2Event.MERGED_CELLS_DOUBLE_CLICK, props.onMergedCellsDoubleClick, s2);
  useCellEvent(S2Event.MERGED_CELLS_MOUSE_DOWN, props.onMergedCellsMouseDown, s2);
  useCellEvent(S2Event.MERGED_CELLS_MOUSE_UP, props.onMergedCellsMouseUp, s2);
  useCellEvent(S2Event.MERGED_CELLS_MOUSE_MOVE, props.onMergedCellsMouseMove, s2);
  ...
  useS2Event(S2Event.LAYOUT_AFTER_HEADER_LAYOUT, props.onLayoutAfterHeaderLayout, s2);
  ...
  useS2Event(S2Event.LAYOUT_AFTER_COLLAPSE_ROWS, props.onLayoutAfterCollapseRows, s2);
  useS2Event(S2Event.LAYOUT_TREE_ROWS_COLLAPSE_ALL, props.onCollapseRowsAll, s2);
  ...
  useS2Event(S2Event.LAYOUT_RESIZE_SERIES_WIDTH, props.onLayoutResizeSeriesWidth, s2);
  useS2Event(S2Event.LAYOUT_RESIZE_ROW_WIDTH, props.onLayoutResizeRowWidth, s2);
  useS2Event(S2Event.LAYOUT_RESIZE_ROW_HEIGHT, props.onLayoutResizeRowHeight, s2);
  useS2Event(S2Event.LAYOUT_RESIZE_COL_WIDTH, props.onLayoutResizeColWidth, s2);
  useS2Event(S2Event.LAYOUT_RESIZE_COL_HEIGHT, props.onLayoutResizeColHeight, s2);
  useS2Event(S2Event.LAYOUT_RESIZE_TREE_WIDTH, props.onLayoutResizeTreeWidth, s2);
  useS2Event(S2Event.LAYOUT_RESIZE_MOUSE_DOWN, props.onLayoutResizeMouseDown, s2);
  useS2Event(S2Event.LAYOUT_RESIZE_MOUSE_UP, props.onLayoutResizeMouseUp, s2);
  useS2Event(S2Event.LAYOUT_RESIZE_MOUSE_MOVE, props.onLayoutResizeMouseMove, s2);
...
const useLoading = (s2, loadingFromProps) => {
  const [loading, setLoading] = React.useState(loadingFromProps);
  React.useEffect(() => {
...
const usePagination = (s2, props) => {
  var _a, _b, _c, _d;
  const { options } = props;
  const [total, setTotal] = React.useState((_b = (_a = s2 == null ? void 0 : s2.facet) == null ? void 0 : _a.viewCellHeights.getTotalLength()) != null ? _b : 0);
  const paginationRef = useLatest(options.pagination);
  const [current, setCurrent] = React.useState(((_c = options.pagination) == null ? void 0 : _c.current) || DEFAULT_PAGE_NUMBER);
  const [pageSize, setPageSize] = React.useState(((_d = options.pagination) == null ? void 0 : _d.pageSize) || DEFAULT_PAGE_SIZE);
  React.useEffect(() => {
...
const useResize = (params) => {
  ...
  const render = React.useCallback((width, height) => {
...
function useSpreadSheet(props, config2) {
  ...
  const renderSpreadSheet = React.useCallback((container) => {
    ...
    if (config2.sheetType === "table") {
      return new TableSheet$1(container, dataCfg, s2Options);
    }
    return new PivotSheet$1(container, dataCfg, s2Options);
...
var index$1 = "";
const BaseSheet = React.forwardRef((props, ref) => {
  var _a;
  ...
  return /* @__PURE__ */ React.createElement(React.StrictMode, null, /* @__PURE__ */ React.createElement(Spin, {
    spinning: loading,
    wrapperClassName: `${S2_PREFIX_CLS}-spin`
  }, /* @__PURE__ */ React.createElement("div", {
    ref: wrapRef,
    className: `${S2_PREFIX_CLS}-wrapper`
  }, header2 && /* @__PURE__ */ React.createElement(Header, __spreadProps(__spreadValues({}, header2), {
    sheet: s2Ref.current,
    width: options.width,
  ...
  }), showPagination && /* @__PURE__ */ React.createElement(S2Pagination, __spreadProps(__spreadValues({}, pagination), {
...
const TableSheet = React.memo((props) => {
  var _a;
  const { options } = props;
  const s2Ref = React.useRef();
  React.useEffect(() => {
  ...
  return /* @__PURE__ */ React.createElement(BaseSheet, __spreadProps(__spreadValues({}, props), {
    ref: s2Ref
  }));
});
TableSheet.displayName = "TableSheet";
class CustomCell extends DataCell {
  drawTextShape() {
...
const GridAnalysisSheet = React.memo((props) => {
  ...
  return /* @__PURE__ */ React.createElement(BaseSheet, __spreadValues({
    options: s2Options,
    themeCfg: S2ThemeCfg,
    ref: s2Ref
  }, restProps));
...
const RowTooltip = ({ cell }) => {
  ...
  }, value2), description && /* @__PURE__ */ React.createElement("div", null, i18n("\u8BF4\u660E"), ": ", description));
};
const ColTooltip = ({ cell }) => {
  ...
  }, cellName), /* @__PURE__ */ React.createElement("span", {
...
const DataTooltip = ({ cell }) => {
  var _a, _b, _c;
  const meta = cell.getMeta();
  const currentRow = React.useMemo(() => find$2(meta.spreadsheet.getRowNodes(), {
    rowIndex: meta.rowIndex
  }), [meta]);
  const currentLeafCol = React.useMemo(() => find$2(meta.spreadsheet.getColumnNodes(), {
  ...
  return /* @__PURE__ */ React.createElement("div", {
  ...
  }, rowName), /* @__PURE__ */ React.createElement("span", null, value2 != null ? value2 : placeholder)), /* @__PURE__ */ React.createElement("div", {
    className: styles.originalValue
  }, ((_c = originalValue2 == null ? void 0 : originalValue2[0]) == null ? void 0 : _c[0]) || placeholder), !isEmpty(derivedValues2) && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
    ...
    }, derivedLabels[i]), /* @__PURE__ */ React.createElement("span", {
      className: cx(styles.derivedValueGroup, {
        [styles.up]: isUp,
        [styles.down]: isDown
      })
    }, !isNormal && /* @__PURE__ */ React.createElement("span", {
...
class CustomColCell extends ColCell {
  ...
  drawTextShape() {
    ...
    const values2 = safeJsonParse(fieldValue);
    if (isArray$1(values2)) {
      drawObjectText(this, { values: [values2] }, true);
    } else {
      super.drawTextShape();
    }
  }
...
class StrategyDataSet extends CustomTreePivotDataSet {
...
const StrategySheet = React.memo((props) => {
  ...
  const strategySheetOptions = React.useMemo(() => {
    ...
    return {
      ...
      tooltip: {
        ...
        row: {
          content: (cell, defaultTooltipShowOptions) => /* @__PURE__ */ React.createElement(RowTooltip, {
            cell,
            defaultTooltipShowOptions
          })
        },
        col: {
          content: (cell, defaultTooltipShowOptions) => /* @__PURE__ */ React.createElement(ColTooltip, {
            cell,
            defaultTooltipShowOptions
          })
        },
        data: {
          content: (cell, defaultTooltipShowOptions) => /* @__PURE__ */ React.createElement(DataTooltip, {
            cell,
            defaultTooltipShowOptions
          })
        }
...
const DrillDown = (_m) => {
  ...
  const DRILL_DOWN_ICON_MAP = {
    text: /* @__PURE__ */ React.createElement(TextIcon, null),
    location: /* @__PURE__ */ React.createElement(LocationIcon, null),
    date: /* @__PURE__ */ React.createElement(CalendarIcon, null)
  };
  const getOptions2 = () => {
  ...
  const [options, setOptions] = useState(getOptions2());
  ...
  return /* @__PURE__ */ React.createElement(ConfigProvider, null, /* @__PURE__ */ React.createElement("div", __spreadValues({
    className: cx(PRE_CLASS2, className)
  }, restProps), /* @__PURE__ */ React.createElement("header", {
    className: `${PRE_CLASS2}-header`
  }, /* @__PURE__ */ React.createElement("div", null, titleText), /* @__PURE__ */ React.createElement(Button, {
    type: "link",
    disabled: isEmpty(drillFields),
    onClick: handleClear
  }, clearButtonText)), /* @__PURE__ */ React.createElement(Input, {
    ...
    allowClear: true
  }), isEmpty(options) && /* @__PURE__ */ React.createElement(Empty, {
    imageStyle: { height: "64px" },
    className: `${PRE_CLASS2}-empty`
  }), extra, /* @__PURE__ */ React.createElement(Menu, {
    className: `${PRE_CLASS2}-menu`,
    selectedKeys: drillFields,
    onSelect: handleSelect
  }, options.map((option) => /* @__PURE__ */ React.createElement(Menu.Item, {
    key: option.value,
...
const PivotSheet = React.memo((props) => {
  const { dataCfg, partDrillDown, options } = props;
  const drillDownIconRef = React.useRef();
  ...
  const onDrillDownIconClick = (sheetInstance, cacheDrillFields, disabledFields, event) => {
    const content = /* @__PURE__ */ React.createElement(DrillDown, __spreadProps(__spreadValues({}, drillConfigRef.current), {
      setDrillFields,
...
const Sheet = React.forwardRef((props, ref) => {
  ...
  const CurrentSheet = React.useMemo(() => {
    switch (sheetType) {
      case "table":
        return /* @__PURE__ */ React.createElement(TableSheet, __spreadValues({}, sheetProps));
      case "gridAnalysis":
        return /* @__PURE__ */ React.createElement(GridAnalysisSheet, __spreadValues({}, sheetProps));
      case "strategy":
        return /* @__PURE__ */ React.createElement(StrategySheet, __spreadValues({}, sheetProps));
      default:
        return /* @__PURE__ */ React.createElement(PivotSheet, __spreadValues({}, sheetProps));
    }
  }, [sheetType, sheetProps]);
  return /* @__PURE__ */ React.createElement(React.StrictMode, null, CurrentSheet);
});
Sheet.displayName = "SheetComponent";
const SheetComponent = React.memo(Sheet);
export { AdvancedSort, BaseSheet, DrillDown, GridAnalysisSheet, SheetComponent, StrategySheet, Switcher, TableSheet, TooltipComponent };
